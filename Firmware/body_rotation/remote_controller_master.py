            ...
            for event in pygame.event.get():
                ...
                if self.button_data[2]:
                    ...
                    try:
                        ...
                        axis_data_1_z = (
                            self._map(axis_data_1_z, -1, 1, 0, 40))

                        axis_data_2_z = self.axis_data[1]
                        axis_data_2_z = (
                            self._map(axis_data_2_z, -1, 1, 40, 100))
                    ...
                    self.sendLoad(
                        bytearray([2, (axis_data_1_z), (axis_data_2_z)]))
                ...
                if self.button_data[4]:
                    print("Rotation Mode")
                    data_points = list(self.getEquidistantPoints(
                        (10, 65), (155, 95), 200))
                    ...
                    self.currentY1 = data_points[200 - pointZ][0]
                    self.currentZ1 = data_points[200 - pointZ][1]
