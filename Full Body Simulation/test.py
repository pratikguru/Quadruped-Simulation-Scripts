...
class App(QMainWindow):
    def __init__(self):
        ...
        #Leg - 1
        self.horizontalSlider.valueChanged.connect(lambda value, point="x", leg=1: self.moveLeg(value, point, leg))
        self.horizontalSlider_2.valueChanged.connect(lambda value, point="y", leg=1: self.moveLeg(value, point, leg))
        self.horizontalSlider_3.valueChanged.connect(lambda value, point="z", leg=1: self.moveLeg(value, point, leg))
        
        #Leg - 2
        self.horizontalSlider_18.valueChanged.connect(lambda value, point="x", leg=2: self.moveLeg(value, point, leg))
        self.horizontalSlider_16.valueChanged.connect(lambda value, point="y", leg=2: self.moveLeg(value, point, leg))
        self.horizontalSlider_17.valueChanged.connect(lambda value, point="z", leg=2: self.moveLeg(value, point, leg))
        
        #Leg - 3
        self.horizontalSlider_15.valueChanged.connect(lambda value, point="x", leg=3: self.moveLeg(value, point, leg))
        self.horizontalSlider_13.valueChanged.connect(lambda value, point="y", leg=3: self.moveLeg(value, point, leg))
        self.horizontalSlider_14.valueChanged.connect(lambda value, point="z", leg=3: self.moveLeg(value, point, leg))
        
        #Leg - 4
        self.horizontalSlider_21.valueChanged.connect(lambda value, point="x", leg=4: self.moveLeg(value, point, leg))
        self.horizontalSlider_19.valueChanged.connect(lambda value, point="y", leg=4: self.moveLeg(value, point, leg))
        self.horizontalSlider_20.valueChanged.connect(lambda value, point="z", leg=4: self.moveLeg(value, point, leg))
        ...
        self.horizontalSlider_24.valueChanged.connect(lambda value, leg="coxa": self.handleBodyLegLengthChange(value, leg))
        self.horizontalSlider_22.valueChanged.connect(lambda value, leg="tibia": self.handleBodyLegLengthChange(value, leg))
        self.horizontalSlider_23.valueChanged.connect(lambda value, leg="femur": self.handleBodyLegLengthChange(value, leg))
    ...
    def animateLegCurve(self):
      ...
      for x in range(0, 5):
        for q in range(1, data_points):
          data = list(self.getEquidistantPoints((80,50), (80,25), data_points))
          data2 = list(self.getEquidistantPoints((80,50), (80,25), data_points))
          
          self.moveLegOne(80, data[q][0], data[q][1])
          self.moveLegTwo(80, data2[q][0], data2[q][1])

          data3 = list(self.getEquidistantPoints((80,50), (80,80), data_points))
          data4 = list(self.getEquidistantPoints((80,50), (80,80), data_points))
        ...
        for q in range(1, data_points):
          data = list(self.getEquidistantPoints((80,50), (40,50), data_points))
          data2 = list(self.getEquidistantPoints((80,50), (120,50), data_points))
          self.moveLegOne(80, data[q][0], data[q][1])
          self.moveLegTwo(80, data2[q][0], data2[q][1])

          data3 = list(self.getEquidistantPoints((80,80), (40 ,80), data_points))
          data4 = list(self.getEquidistantPoints((80,80), (120,80), data_points))
        ...
        for q in range(1, data_points):
          data = list(self.getEquidistantPoints((40,50), (40,50), data_points))
          data2 = list(self.getEquidistantPoints((120,50), (120, 50), data_points))
          self.moveLegOne(80, data[q][0], data[q][1])
          self.moveLegTwo(80, data2[q][0], data2[q][1])

          data3 = list(self.getEquidistantPoints((40, 80),  (40,50),  data_points))
          data4 = list(self.getEquidistantPoints((120, 80), (120,50), data_points))
          self.moveLegThree(80, data3[q][0], data3[q][1])
          self.moveLegFour(80,  data4[q][0], data4[q][1])
          plt.pause(0.00001)

        for q in range(1, data_points):
          data = list(self.getEquidistantPoints((40,50), (80,50), data_points))
          data2 = list(self.getEquidistantPoints((120,50), (80, 50), data_points))
          self.moveLegOne(80, data[q][0], data[q][1])
          self.moveLegTwo(80, data2[q][0], data2[q][1])
          
          data3 = list(self.getEquidistantPoints((40, 50), (80,50), data_points))
          data4 = list(self.getEquidistantPoints((120, 50), (80,50), data_points))
          self.moveLegThree(80, data3[q][0], data3[q][1])
          self.moveLegFour(80, data4[q][0], data4[q][1])
    ...
    def animateLegRaise(self):
      ...
      stride_length = [stride_length_start+self.translateY, stride_length_end+self.translateY]
      stride_height = [stride_height_start+self.translateZ, stride_height_end+self.translateZ]
